...
export function Tag({ children, className, ...props }: TagProps) {
  ...
  return (
    <PrimitiveTag
      textValue={textValue}
      className={cx(
        'inset-ring inset-ring-border outline-hidden bg-overlay dark:bg-input/30',
        ...
        'selected:inset-ring-primary-subtle-fg selected:bg-primary selected:text-primary-fg',
